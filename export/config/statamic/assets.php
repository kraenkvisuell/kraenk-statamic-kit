...
return [
    ...
    'image_manipulation' => [
        ...
        */
        ...
        'cache' => env('GLIDE_CACHE_DISK', false),
        ...
        */
        ...
        'defaults' => [
            // every Glide output as WebP (photos, gallery, award PNGs – SVGs are
            // not put through Glide, animated GIFs would lose their animation)
            'format' => 'webp',
            'quality' => 80,
        ],
