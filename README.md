...
2. `php artisan migrate`, then `php artisan kit:init` (single- or multisite, demo pages and navigations, blog posts, projects and partners, SEO Pro site defaults, the super user test@kraenk.de / password).
