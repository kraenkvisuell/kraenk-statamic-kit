...
2. `php artisan migrate`, then `php artisan kit:init` (demo pages and navigations, blog posts and projects, SEO Pro site defaults, then your super user).
